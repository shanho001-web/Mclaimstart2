...
function Router() {
  return <Switch><Route path="/" component={Home}/><Route path="/lesson-2-github" component={GithubLesson}/><Route path="/lesson-3-vercel" component={VercelLesson}/><Route path="/lesson-4-firebase" component={FirebaseLesson}/><Route path="/tool-guides" component={GithubLesson}/><Route path="/claim-kit" component={ClaimKit}/><Route path="/member-guide" component={MemberGuide}/><Route path="/404" component={NotFound}/><Route component={NotFound}/></Switch>;
}
