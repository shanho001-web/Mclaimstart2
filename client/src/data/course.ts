...
export const steps: CourseStep[] = [
  ...
  { id:"update", number:"05", title:"改一句字，親眼看自動更新", short:"改字 → push → 新版上線", tool:"VS Code、GitHub、Vercel", reward:"你已掌握日後更新節奏", goal:"最後只改一行字，親眼看到 GitHub 和 Vercel 自動合作。完成後你就知道日後如何自己更新網站。", guides:[
    ...
    { visual:"vercel", title:"確認 GitHub 收到新版本，再等 Vercel Ready", instruction:"瀏覽器 → GitHub 的 welcome-site 頁面；之後 → Vercel Project → Deployments。", detail:"查看更新是否自動發布。", microSteps:["重新整理 GitHub，檔案上方看見「改了歡迎文字」的最新 commit", "進入 Vercel Deployments", "等待最上方由 Building 變為 Ready"], result:"GitHub 已保存新版本，而且 Vercel 最上方 deployment 顯示最新的 Ready。", tip:"看到 GitHub 的新 commit 後，Vercel 會自動開始工作；不用再次上載檔案。" },
